...
TunedBlocks = {'controller_lon/KP_theta'; ...
        %       'controller_lon/KI_theta'; ...
               'controller_lon/KP_q'; ...
         %      'controller_lon/KF_theta'; ...
               'controller_lon/KP_q2'};
AnalysisPoints = {'controller_lon/Step/1'; ...
                  'controller_lon/Gain2/1'; ...
                  'controller_lon/ActuatorsDynamics/1'};
% Specify the custom options
Options = slTunerOptions('AreParamsTunable',false);
% Create the slTuner object
CL0 = slTuner('controller_lon',TunedBlocks,AnalysisPoints,Options);

%% Create tuning goal to shape how the closed-loop system respondes to a specific input signal
% Inputs and outputs
Inputs = {'controller_lon/Step/1'};
Outputs = {'controller_lon/Gain2/1[theta]'};
...
Locations = {'controller_lon/ActuatorsDynamics/1'}; % Feedback loop locations
% Tuning goal specifications
