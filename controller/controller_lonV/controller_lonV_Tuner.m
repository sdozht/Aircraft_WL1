...
TunedBlocks = {'controller_lonV/KP_V'; ...
               'controller_lonV/KF_V'; ...
               'controller_lonV/KI_V'};
AnalysisPoints = {'controller_lonV/Vc/1'; ...
                  'controller_lonV/V_ABS/1'; ...
                  'controller_lonV/ActuatorsDynamics1/1'};
% Specify the custom options
Options = slTunerOptions('AreParamsTunable',false);
% Create the slTuner object
CL0 = slTuner('controller_lonV',TunedBlocks,AnalysisPoints,Options);

%% Create tuning goal to shape how the closed-loop system respondes to a specific input signal
% Inputs and outputs
Inputs = {'controller_lonV/Vc/1'};
Outputs = {'controller_lonV/V_ABS/1'};
...
Locations = {'controller_lonV/ActuatorsDynamics1/1'}; % Feedback loop locations
% Tuning goal specifications
...
%
writeBlockValue(CL1);
fprintf("\nKP_q = %f\nKP_q2 = %f\nKP_theta = %f\nKI_theta = %f\nKF_theta = %f\nKI_Hdot = %f\nKP_Hdot = %f\nKP_V = %f\nKI_V = %f\n",KP_q,KP_q2,KP_theta,KI_theta,KF_theta,KI_Hdot,KP_Hdot,KP_V,KI_V);
%}
