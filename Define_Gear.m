...
%% 起落架默认配置
    ...
    Default_Strut.POS_R_GearStrut_B   = [-0.3998, 3, 1.28]';                % 起落架触地点相对于参考重心的位置(体轴系) [m]
    Default_Strut.h_StrutUndeflected  = 1.28;
...
%% BWB Nose Gear Strut Definition
    ...
    Gear.NoseStrut.POS_R_GearStrut_B        = [3.5978, 0, 1.28]';             % Position R of Gear Contact point in Body Frame [m]
    Gear.NoseStrut.c                        = 8418.6;                       % Spring Constant of damper strut [N/m]
    Gear.NoseStrut.ct                       = 10*8418.6;                    % Spring Constant of tire [N/m]
    Gear.NoseStrut.d                        = 5000;                          % Damping Constant of damper strut [N/(m/s)]
    Gear.NoseStrut.dt                       = 1000;                          % Damping Constant of tire [N/(m/s)]
    
%% BWB Left Main Gear Strut Definition
    Gear.LeftMainStrut                      = Default_Strut;                % Pre-Allocate Left Main Gear Strut with Default
    Gear.LeftMainStrut.POS_R_GearStrut_B    = [-0.3998, -3, 1.28]';         % Position R of Gear Contact point in Body Frame [m]
    Gear.LeftMainStrut.c                    = 37879;                       % Spring Constant of damper strut [N/m]
    Gear.LeftMainStrut.ct                   = 10*37879;                    % Spring Constant of tire [N/m]
    Gear.LeftMainStrut.d                    = 5000;                          % Damping Constant of damper strut [N/(m/s)]
    Gear.LeftMainStrut.dt                   = 1000;                          % Damping Constant of tire [N/(m/s)]    
...
%% BWB Right Main Gear Strut Definition
    ...
    Gear.RightMainStrut.POS_R_GearStrut_B   = [-0.3998, 3, 1.28]';         % Position R of Gear Contact point in Body Frame [m]
    Gear.LeftMainStrut.c                    = 37879;                       % Spring Constant of damper strut [N/m]
    Gear.LeftMainStrut.ct                   = 10*37879;                    % Spring Constant of tire [N/m]
    Gear.LeftMainStrut.d                    = 5000;                          % Damping Constant of damper strut [N/(m/s)]
    Gear.LeftMainStrut.dt                   = 1000;                         % Damping Constant of tire [N/(m/s)]  
